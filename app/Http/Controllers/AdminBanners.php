...
class AdminBanners extends Controller
{
    ...
    //         if (!file_exists(public_path('assets/admin/banners'))) {
    //             mkdir(public_path('assets/admin/banners'), 0777, true);
    //         }
    //         $imageName = uniqid() . '.' . $image->getClientOriginalExtension();
    //         $image->move(public_path('assets/admin/banners'), $imageName);
    //         $banner = new Banner;
    //         $banner->image_path = 'assets/admin/banners/' . $imageName;
    //         $banner->save();

    //         // Trả về thông báo thành công hoặc redirect đến trang khác
    //         return redirect()->back()->withSuccess('Banner image uploaded successfully.');
    //     }

    //     // Trả về thông báo lỗi nếu không có tệp tin hình ảnh
    //     return redirect()->back()->withErrors('No image file found.');
    // }
