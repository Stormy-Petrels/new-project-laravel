      ...
      <div class="custom-container-6">
        <div class="columns">
          <div class="custom-container-7">
            <img loading="lazy"
              srcset="assets/patients/images/home.png" class="img" />
        ...
        <div class="columns">
          <div class="custom-container-7">
            <img loading="lazy"
              srcset="assets/patients/images/person.png" class="img" />
        ...
        <div class="columns">
          <div class="custom-container-7">
            <img loading="lazy"
              srcset="assets/patients/images/infusion_pumps.png"class="img" />
        ...
        <div class="columns">
          <div class="custom-container-7">
              <img loading="lazy"
                  srcset="assets/patients/images/doctor_bag.png"
                  class="img" />
    ...
    <div class="right">
      <div class="right-1">
        <div class="right-2">
          <img
            loading="lazy"
            srcset="assets/patients/images/lightning.png"
            class="image1"
          />
      ...
      <div class="right-1">
        <div class="right-2">
          <img
            loading="lazy"
            srcset="assets/patients/images/tick.png"
            class="image1"
          />
      ...
      <div class="right-1">
        <div class="right-2">
          <img
            loading="lazy"
            srcset="assets/patients/images/development_skill.png"
            class="image1"
          />
  ...
  <div class="team">
    ...
    <div class="h2">
      <div class="h3">
        ...
        <div class="title">
          <div class="titles">
            <span style="font-weight: 700; color: rgba(0, 0, 0, 1)">
              Dr. Leslie Taylor
            </span>
            <span style="font-weight: 400; font-size: 24px; color: rgba(28, 187, 208, 1);">
              PEDIATRICIAN
            </span>
            <br>
            <span style=" font-weight: 400; font-size: 24px; color: rgba(118, 118, 118, 1);">
                Eos nam veniam unde quia nihil asperiores officiis volupt
            </span>
          </div>
        </div>
      </div>
