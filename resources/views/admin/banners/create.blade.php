...
<div class="head-title flex items-center">
    <a href="{{url('/admin/banners')}}" class="flex items-center mr-4 mb-4">
        ...
        <h1 class="text-2xl font-bold ml-2">Add new banner</h1>
    </a>
</div>
<form action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="flex items-center justify-center w-full">
        ...
        <div id="image-preview" class="w-1/2 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 rounded-lg">
            <img id="preview" src="" alt="Preview Image" class="w-full h-full object-contain" />
        </div>
    </div>
    <div class="flex justify-left mt-4">
        <button type="submit" class="px-4 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600">Add</button>
    </div>
